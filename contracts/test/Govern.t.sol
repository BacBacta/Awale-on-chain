...
/// @notice Verifies the timelock + multisig ownership handover and that admin
///         changes then flow through schedule -> (delay) -> execute.
contract GovernTest is Test {
    ...
    function test_directAdminCallNowReverts() public {
        // the old owner can no longer change anything directly
        vm.expectRevert();
        escrow.setRake(500);
    }
