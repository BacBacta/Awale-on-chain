  ...
  return (
    <main className="pad stack" style={{ flex: 1, gap: 14 }}>
      ...
      <div className="stack" style={{ gap: 8 }}>
        <Way icon="bolt" title="Quick match" sub="Free · live vs a real player · 3 minutes each" />
      ...
      <div className="card stack" style={{ gap: 10 }}>
        ...
        <Point n={2}>
          Timers keep games honest: live games give each player 3 minutes; friend games allow days per move. If an
